...
public enum JwtUtil {
    ...
    public boolean isRefreshTokenTimeExpired(RefreshTokenClaimsDto refreshTokenClaimsDto) {
        return refreshTokenClaimsDto.getExp().before(new Date());
    }

    public boolean isRefreshTokenCountExpired(RefreshTokenClaimsDto refreshTokenClaimsDto) {
        return refreshTokenClaimsDto.getCount() <= 0;
    }
